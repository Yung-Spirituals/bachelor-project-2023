To download the project, install git and do "git clone https://github.com/Yung-Spirituals/bachelor-project-2023.git" or choose "Download ZIP" after pressing the "code<>" button and then extract the file.
