    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        if (existingStory.isEmpty()) {
            ...
            Story s1 = new Story("Geografi", "iconUrl", "backgroundUrl",
                    ...
                    "Test geografikunnskapene dine med varierte quizspørsmål fra lett til avansert. Du må" +
                            " få minst én stjerne på hvert nivå for å komme deg videre.");
            Story s2 = new Story("Musikk", "iconUrl", "backgroundUrl",
                    "A plant that makes you cry", "what is an onion?",
                    "Test musikkkunnskapene dine med varierte quizspørsmål fra lett til avansert. Du må" +
                            " få minst én stjerne på hvert nivå for å komme deg videre.");
            ...
            Level s1l4 = new Level(s1, "Nivå 4", "url", GameTypes.MemoryCards.toString(),
            ...
            // Standard.
            Question s1l1q1 = new Question(s1l1, "Hva er hovedstaden i Australia?", "https://lp-cms-production.imgix.net/2019-06/f22a1e4f3307b7455a76bffcc0e504b7-canberra.jpg",
                    "Sydney", "Canberra", "Melbourne", "Adeleide",
                    false, true, false, false);

            Question s1l1q2 = new Question(s1l1, "Hva er hovedstaden i Canada?", "https://a.cdn-hotels.com/gdcs/production163/d857/cc29dd0e-f745-4507-80e1-6ae5a3532338.jpg",
                    "Toronto", "Vancouver", "Winnipeg", "Ottawa",
                    false, false, false, true);

            Question s1l1q3 = new Question(s1l1, "Hva er hovedstaden i Hellas?", "https://cdn.britannica.com/66/102266-050-FBDEFCA1/acropolis-city-state-Greece-Athens.jpg",
                    "Creta", "Athen", "Heraklion", "Rethimno",
                    false, true, false, false);

            Question s1l1q4 = new Question(s1l1, "Hva er hovedstaden i Japan?", "https://assets.editorial.aetnd.com/uploads/2013/07/gettyimages-1390815938.jpg",
                    "Osaka", "Kyoto", "Tokyo", "Yokohama",
                    false, false, true, false);

            Question s1l1q5 = new Question(s1l1, "Hva er hovedstaden i India?", "https://www.travelandleisure.com/thmb/iAIrOVW7yWrDG8pZBpKMOvEGuNQ=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/new-delhi-india-NEWDELHITG0721-60d592e1603349298a0206d67d08582b.jpg",
                    "Mumbai", "New Delhi", "Chennai", "Kolkata",
                    false, true, false, false);

            Question s1l1q6 = new Question(s1l1, "Hva er hovedstaden i Island?", "https://www.icelandtravel.is/_next/image/?url=https%3A%2F%2Ficetprodgreen.wpengine.com%2Fwp-content%2Fuploads%2F2019%2F03%2FReykjavik.jpg&w=3840&q=75",
                    "Reykjavik", "Akureyri", "Mosfellsbær", "Kópavogur",
                    true, false, false, false);

            Question s1l1q7 = new Question(s1l1, "Hva er hovedstaden i Cuba", "https://content.r9cdn.net/rimg/dimg/a3/1d/05f2b4a1-city-11020-1700c4dba73.jpg?crop=true&width=1020&height=498",
                    "Varadero", "Cienfuegos", "Santiago de Cuba", "Havana",
                    false, false, false, true);

            Question s1l1q8 = new Question(s1l1, "Hva er hovedstaden i El Salvador?", "https://www.thegef.org/sites/default/files/styles/full_width_card/public/shutterstock_578720257_san_salvador.jpg?h=e85f6c07&itok=34HoStFm",
                    "Apopa", "Delgado", "San Salvador", "Santa Tecla",
                    false, false, true, false);

            Question s1l1q9 = new Question(s1l1, "Hva er hovedstaden i Indonesia?", "https://content.r9cdn.net/rimg/dimg/1b/61/ad879e55-city-22380-17ea1cf2107.jpg?crop=true&width=1020&height=498",
                    "Jakarta", "Medan", "Semarang", "Bandung",
                    true, false, false, false);

            Question s1l1q10 = new Question(s1l1, "Hva er hovedstaden i Haiti?", "https://upload.wikimedia.org/wikipedia/commons/3/3a/US_Navy_100221-N-5787K-002_An_aerial_view_of_the_logistical_area_near_the_port_in_Port-au-Prince_%28cropped%29.jpg",
                    "Port-au-Prince", "Delmas", "Carrefour", "Les Cayes",
                    true, false, false, false);


            // True or false.
            Question s1l2q1 = new Question(s1l2, "Frihetsgudinnen står på Ellis øya", "https://www.nps.gov/stli/planyourvisit/images/Liberty-statue-with-manhattan_1.jpg",
                    "Sant", "Usant", "", "",
                    false, true, false, false);

            Question s1l2q2 = new Question(s1l2, "Taj Mahal ligger i New Delhi", "https://cdn.britannica.com/86/170586-050-AB7FEFAE/Taj-Mahal-Agra-India.jpg",
                    "Sant", "Usant", "", "",
                    false, true, false, false);

            Question s1l2q3 = new Question(s1l2, "Burj Khalifa ligger i Dubai", "https://media.cnn.com/api/v1/images/stellar/prod/180301130119-burj-khalifa-dubai-guide-8.jpg?q=w_3000,h_2000,x_0,y_1,c_crop",
                    "Sant", "Usant", "", "",
                    true, false, false, false);

            Question s1l2q4 = new Question(s1l2, "Akropolis ligger i Athen", "https://cdn-imgix.headout.com/microbrands-banner-image/image/b698f96a3bf7e35418940973f33c4708-The%20Acropolis%20of%20Athens.jpeg",
                    "Sant", "Usant", "", "",
                    true, false, false, false);

            Question s1l2q5 = new Question(s1l2, "Påskeøya ligger utenfor kysten til Chile", "https://media.snl.no/media/45540/standard_compressed_paaskeoeya.jpg",
                    "Sant", "Usant", "", "",
                    true, false, false, false);

            Question s1l2q6 = new Question(s1l2, "Den Kinesiske Mur beffiner seg kun i Beijing", "https://images.nationalgeographic.org/image/upload/t_edhub_resource_key_image/v1638892506/EducationHub/photos/the-great-wall-of-china.jpg",
                    "Sant", "Usant", "", "",
                    false, true, false, false);

            Question s1l2q7 = new Question(s1l2, "Mount Rushmore ligger i North Dakota", "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Mount_Rushmore_detail_view_%28100MP%29.jpg/1200px-Mount_Rushmore_detail_view_%28100MP%29.jpg",
                    "Sant", "Usant", "", "",
                    false, true, false, false);

            Question s1l2q8 = new Question(s1l2, "Stonehenge ligger i Amesbury", "https://www.britishmuseum.org/sites/default/files/styles/uncropped_small/public/2021-12/Stonehenge_Courtesy_of_English_Heritage.jpg?itok=0F9_g3yY",
                    "Sant", "Usant", "", "",
                    false, true, false, false);

            Question s1l2q9 = new Question(s1l2, "Victoria Falls ligger mellom Zimbabwe og Zambia", "https://cdn.tourradar.com/s3/content-pages/375/1200x630/EHIBb9.jpeg",
                    "Sant", "Usant", "", "",
                    true, false, false, false);

            Question s1l2q10 = new Question(s1l2, "Golden Gate Bridge forbinder San Francisco og Marin County", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/GoldenGateBridge-001.jpg/1200px-GoldenGateBridge-001.jpg",
                    "Sant", "Usant", "", "",
                    true, false, false, false);
